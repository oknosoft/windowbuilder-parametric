...
- С помощью специальной обработки (кнопка в заказе или списке заказов или регламентное задание), _Заказ_ или _Пачка заказов_, отправляются в сервис _Заказы онлайн_
